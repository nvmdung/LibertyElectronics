     ...
     <div>    
            <tbody>
                <tr>
                    ...
                    <th className="cartlistprice">
                        <div>
                        ${product.discount ? 
                            ((product.price - (product.price * (product.discount / 100))).toFixed(2)) : (product.price.toFixed(2))}
                        </div>
                    </th>
                    ...
                    <th className="cartlisttotal">{formatCurrency((product.quantity * (product.discount ? (product.price - (product.price * (product.discount / 100))) : product.price)).toFixed(2))}</th>
