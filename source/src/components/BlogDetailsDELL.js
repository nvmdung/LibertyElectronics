        ...
        <div class="blogdetail_content">
          <div class="blogdetail_item">
            <div class="blogdetail_overlay">
              <img className="img" src="../img/DELL.png" alt="laptop1" />
              <div class="blog_text">
                <h4>Dell</h4>
                <p> "Dell Inc., global company that designs, develops, and manufactures personal computers (PCs) and a variety of computer-related products. The company is one of the world’s leading computer brands and suppliers of PCs. Dell is headquartered in Round Rock, Texas.
